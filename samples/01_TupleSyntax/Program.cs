...
static void SpaceTemplateSyntax()
{
    ...
    Console.WriteLine($"Space template with new SpaceUnit() field: {new SpaceTemplate(1, "a", new SpaceUnit(), 1.5f)}");
    Console.WriteLine($"Space template with new SpaceUnit() and \"NULL\" string: {new SpaceTemplate(new SpaceUnit(), "NULL")}");
...
static void SpaceTemplateEquality()
{
    ...
    Console.WriteLine($"These are equal (fields, types, values, indices - match): {new SpaceTemplate(1, "a", typeof(int), new SpaceUnit())}, {new SpaceTemplate(1, "a", typeof(int), new SpaceUnit())}");
    ...
    Console.WriteLine($"These are not equal (types, values, indices match - fields don't): {new SpaceTemplate(1)}, {new SpaceTemplate(1, new SpaceUnit())}");
    ...
    Console.WriteLine($"These are not equal (types, values, fields match - indices don't): {new SpaceTemplate("a", new SpaceUnit())}, {new SpaceTemplate(new SpaceUnit(), "a")}");
    ...
    Console.WriteLine($"These are not equal (types, fields, indices match - values don't): {new SpaceTemplate(1, typeof(int))}, {new SpaceTemplate(1, new SpaceUnit())}");
