...
static void SpaceTemplateSyntax()
{
    ...
    Console.WriteLine($"Space template with SpaceUnit.Null field: {new SpaceTemplate(1, "a", SpaceUnit.Null, 1.5f)}");
    Console.WriteLine($"Space template with SpaceUnit.Null and \"NULL\" string: {new SpaceTemplate(SpaceUnit.Null, "NULL")}");
