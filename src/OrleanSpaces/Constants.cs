...
public static class Constants
{
    ...
    internal const string RealmKey_Space = "space-realmKey";
    internal const string RealmKey_Bool = "bool-realmKey";
    internal const string RealmKey_Char = "char-realmKey";
    internal const string RealmKey_Byte = "byte-realmKey";
    internal const string RealmKey_SByte = "sbyte-realmKey";
    internal const string RealmKey_Short = "short-realmKey";
    internal const string RealmKey_UShort = "ushort-realmKey";
    internal const string RealmKey_Int = "int-realmKey";
    internal const string RealmKey_UInt = "uint-realmKey";
    internal const string RealmKey_Long = "long-realmKey";
    internal const string RealmKey_ULong = "ulong-realmKey";
    internal const string RealmKey_Huge = "huge-realmKey";
    internal const string RealmKey_UHuge = "uhuge-realmKey";
    internal const string RealmKey_DateTime = "datetime-realmKey";
    internal const string RealmKey_DateTimeOffset = "datetimeoffset-realmKey";
    internal const string RealmKey_TimeSpan = "timespan-realmKey";
    internal const string RealmKey_Guid = "guid-realmKey";
    internal const string RealmKey_Double = "double-realmKey";
    internal const string RealmKey_Decimal = "decimal-realmKey";
    internal const string RealmKey_Float = "float-realmKey";
}