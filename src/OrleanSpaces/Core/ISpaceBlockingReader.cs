...
public delegate void TuplePromise(SpaceTuple tuple);
...
public interface ISpaceBlockingReader
{
    ...
    /// </summary>
    ValueTask PeekAsync(SpaceTemplate template, TuplePromise promise);
    ...
    /// </summary>
    Task PopAsync(SpaceTemplate template, TuplePromise promise);
}
