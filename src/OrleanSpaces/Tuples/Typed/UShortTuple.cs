...
[Immutable]
public readonly struct UShortTuple : INumericValueTuple<ushort, UShortTuple>, ISpanFormattable
{
    /// <summary>
    /// 
    /// </summary>
    ...
    Span<ushort> INumericValueTuple<ushort, UShortTuple>.Fields => fields.AsSpan();
