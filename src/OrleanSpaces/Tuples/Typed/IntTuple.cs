...
[Immutable]
public readonly struct IntTuple : IVectorizableValueTuple<int, IntTuple>, ISpanFormattable
{
    /// <summary>
    /// 
    /// </summary>
    ...
    Span<int> IVectorizableValueTuple<int, IntTuple>.Fields => fields.AsSpan();
