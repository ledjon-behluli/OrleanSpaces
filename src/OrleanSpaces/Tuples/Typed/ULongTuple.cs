...
[Immutable]
public readonly struct ULongTuple : INumericTuple<ulong, ULongTuple>, ITupleFieldFormater<ulong>
{
    ...
    static int ITupleFieldFormater<ulong>.MaxCharsWrittable => 11;

    static bool ITupleFieldFormater<ulong>.TryFormat(ulong field, Span<char> destination, out int charsWritten)
