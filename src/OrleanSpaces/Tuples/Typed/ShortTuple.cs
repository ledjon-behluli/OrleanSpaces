...
[Immutable]
public readonly struct ShortTuple : IVectorizableValueTuple<short, ShortTuple>, ISpanFormattable
{
    /// <summary>
    /// 
    /// </summary>
    ...
    Span<short> IVectorizableValueTuple<short, ShortTuple>.Fields => fields.AsSpan();
