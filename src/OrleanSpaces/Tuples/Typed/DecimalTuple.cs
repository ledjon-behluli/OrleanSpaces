...
[Immutable]
public readonly struct DecimalTupleV1 : ISpaceTuple<decimal, DecimalTupleV1>
{
    private readonly decimal[] fields;
    ...
    public DecimalTupleV1() : this(Array.Empty<decimal>()) { }
    public DecimalTupleV1(params decimal[] fields) => this.fields = fields;

    public static bool operator ==(DecimalTupleV1 left, DecimalTupleV1 right) => left.Equals(right);
    public static bool operator !=(DecimalTupleV1 left, DecimalTupleV1 right) => !(left == right);

    public override bool Equals(object? obj) => obj is DecimalTupleV1 tuple && Equals(tuple);

    public bool Equals(DecimalTupleV1 other)
    {
        if (Vector256.IsHardwareAccelerated)
        {
            if (Length != other.Length)
    ...
    public int CompareTo(DecimalTupleV1 other) => Length.CompareTo(other.Length);
