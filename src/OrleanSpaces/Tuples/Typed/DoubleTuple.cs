...
[Immutable]
public readonly struct DoubleTuple : INumericValueTuple<double, DoubleTuple>, ISpanFormattable
{
    /// <summary>
    /// 
    /// </summary>
    ...
    Span<double> INumericValueTuple<double, DoubleTuple>.Fields => fields.AsSpan();
