...
[Immutable]
public readonly struct DoubleTuple : IVectorizableValueTuple<double, DoubleTuple>, ISpanFormattable
{
    /// <summary>
    /// 
    /// </summary>
    ...
    Span<double> IVectorizableValueTuple<double, DoubleTuple>.Fields => fields.AsSpan();
